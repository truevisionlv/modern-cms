...
define('CMS_DEVELOPERS', 'TrueVision');
define('CMS_OWNER_COMPANY', 'SIA TrueVision');
define('CMS_SUPPORT_EMAIL', 'info@v.lv'); // Support e-mail for errors, etc.
define('CMS_SITE', 'http://v.lv/');
...
// Error handler
set_error_handler(array('\Log\Errors', 'Handler'));
